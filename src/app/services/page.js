...
export default function Services() {
    ...
    return (
        <>
            <Seo
                title="Beauty & Wellness Services - Mwimpe Organics"
                description="Discover a variety of beauty and wellness services including semi-permanent makeup, microshading, and more at Mwimpe Organics."
                keywords="beauty services, wellness services, microshading, semi-permanent makeup, Mwimpe Organics"
                url="https://mwimpebeauty.co.za/services"
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full relative" role="dialog" aria-labelledby="booking-modal-title">
                                ...
                                <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
                                    ...
                                    {[
                                        ...
                                        "False Beauty Spot Procedure",
                                        "Semi-Permanent Microshaded Eyebrows"
                                    ].includes(bookingDetails.service) && (
                                            <a
                                                href="https://docs.google.com/forms/d/e/1FAIpQLScaBeYHmxjMi2s0q-xaN6eAcffOSjHmvMjnlz6EVDm5zU-HjA/viewform?usp=header"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="w-full inline-block mt-2 text-center bg-transparent text-brown-700 hover:text-white border border-brown-700 hover:bg-brown-700 font-semibold py-2 px-4 rounded"
                                            >
                                                Fill Consent Form (Required)
                                            </a>
                                        )}
