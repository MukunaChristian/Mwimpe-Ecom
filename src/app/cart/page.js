...
export default function CartPage() {
    ...
    return (
        <>
            <Seo
                title="Your Shopping Cart – Mwimpe Beauty"
                description="Review your selected beauty treatments and products before checkout. Mwimpe Beauty – where natural beauty meets confidence."
                url="https://mwimpebeauty.co.za/cart"
            />
