...
export default function AboutUs() {
    return (
        <>
            <Seo
                title="About Us - Mwimpe Organics"
                description="Learn the inspiring story behind Mwimpe Organics, a beauty brand that celebrates natural skin, confidence, and self-love with organic skincare and advanced aesthetic services."
                keywords="about mwimpe, natural skincare, organic beauty, permanent makeup, microshading"
                url="https://mwimpebeauty.co.za/about"
