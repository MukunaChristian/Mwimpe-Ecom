...
export default function ProductsPage() {
    ...
    return (
        <>
            <Seo
                title="Organic Beauty Products - Mwimpe Organics"
                description="Discover our range of organic skincare and beauty products including turmeric soap, African black soap, oils, and creams that nourish your skin naturally."
                keywords="organic skincare, turmeric soap, African black soap, beauty oils, Mwimpe Organics products"
                url="https://mwimpebeauty.co.za/products"
