...
export default function Gallery() {
    return (
        <>
            <Seo
                title="Before & After Gallery - Mwimpe Organics"
                description="Explore the stunning before and after transformations of our clients with Mwimpe Organics' advanced beauty treatments and organic skincare."
                keywords="before after gallery, beauty transformations, organic skincare results, Mwimpe Organics"
                url="https://mwimpebeauty.co.za/gallery"
